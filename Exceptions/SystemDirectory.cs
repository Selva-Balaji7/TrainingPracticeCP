...
namespace namespace1
{
    class SystemDirectory
    {
        ...
        {
            DirectoryInfo d;
            d = new DirectoryInfo(@"C:\Users\selva.balaji\Desktop\.NET");
            //string parentDirectoryPath = @"C:\Users\selva.balaji\Desktop\.NET\NewFolder";
            ...
            //    }
            //}
            //DirectoryInfo parentDir = new DirectoryInfo(parentDirectoryPath);
            //DirectoryInfo newSubDir = parentDir.CreateSubdirectory("SubFolder");
